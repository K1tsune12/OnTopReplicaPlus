    ...
    partial class MainForm : AspectRatioForm {
        ...
        protected override void WndProc(ref Message m) {
            ...
            switch (m.Msg) {
                ...
                case WM.NCLBUTTONDBLCLK:
                    //Double click on caption (whole glass area): either toggle fullscreen,
                    //or, when "double-click to restore" is enabled, bring the cloned source
        ...
        public void SetThumbnail(WindowHandle handle, ThumbnailRegion region) {
            try {
                ...
                //Keep cloned browser windows rendering video even when they appear occluded.
        ...
        /// <summary>
        /// Cycles to the next saved region on the current thumbnail (used by the
        /// "cycle regions" global hotkey). Shows the region name as a brief overlay.
        /// </summary>
        /// <returns>True if a region was applied, false if there is nothing to cycle.</returns>
