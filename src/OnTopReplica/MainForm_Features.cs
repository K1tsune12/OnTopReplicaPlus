...
namespace OnTopReplica {
    ...
    partial class MainForm {
        ...
        #region Double-click to restore

        private bool _isRestoreEnabled;

        /// <summary>
        /// Gets or sets whether double-clicking the replica brings the cloned
        /// source window to the foreground (instead of toggling fullscreen).
        /// </summary>
